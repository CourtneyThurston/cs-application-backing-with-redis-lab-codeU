...
public class JedisIndex {
	...
	public Map<String, Integer> getCounts(String term) {
		...
		Set<String> setUrls = getURLs(term);
		for (String eleUrl: setUrls) {
			Integer counter = getCount(eleUrl, term);
			mapUrl.put(eleUrl, counter);
		}
		return mapUrl;
	}
	...
	public Integer getCount(String url, String term) {
		String newKey = termCounterKey(url);
		return new Integer(jedis.hget(newKey, term));
	}
	...
	public List<Object> pushTermCounterToRedis(TermCounter tc) {
		...
		for (String t: tc.keySet()) {
			Integer counter = tc.get(t);
			trans.hset(hash, t, counter.toString());
			trans.sadd(urlSetKey(t), url);
		}
		return trans.exec();
	}
